package com.jacobparr.twitter.streaming.client;

import com.jacobparr.twitter.streaming.server.ChangeRequest;
...
public class TestClient implements Runnable {
    ...
    public static void main(String[] args) {
        try {
            TestClient client = new TestClient(InetAddress.getByName("localhost"), 9090);
