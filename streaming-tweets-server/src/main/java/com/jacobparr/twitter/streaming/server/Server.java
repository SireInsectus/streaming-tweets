...
public class Server implements Runnable {
    ...
    private final List<SocketChannel> socketChannels = new CopyOnWriteArrayList<>();
    ...
    public void send(Collection<SocketChannel> sockets, byte[] data) {
    ...
    private void read(SelectionKey key) throws IOException {
        ...
        this.worker.processData(this, Collections.singletonList(socketChannel), this.readBuffer.array(), numRead);
    }
